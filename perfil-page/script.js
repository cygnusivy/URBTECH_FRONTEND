...
fetch(`https://5857-45-234-11-160.ngrok-free.app/usuario/retornoUsuario/${userId}`)
    .then(function (res){
        if (res.status === 200){
            return res.json();
        }else{
    ...
    function aatualizarConta(){
        ...
        fetch(`https://5857-45-234-11-160.ngrok-free.app/usuario/atualizarUsuario/${userId}`,
        {
            headers: {
